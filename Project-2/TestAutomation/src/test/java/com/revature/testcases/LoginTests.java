...
public class LoginTests {
   public WebDriver driver;
    ...
    public void setup() {
        ...
        WebDriverManager.firefoxdriver().setup(); // go and download chromedriver.exe (windows) or chromedriver (mac)
    ...
    public Object[][] provideValidLogins() throws IOException {
        ...
        File file = new File("src/test/resources/test1.xlsx");
    ...
    public void validLogin(String username, String password) {
        ...
        driver.get("http://127.0.0.1:5500/index.html"); // URL for frontend
        ...
        wdw.until(ExpectedConditions.urlToBe("http://127.0.0.1:5500/admin.html")); // explicit wait
        ...
        IndexPage successPage = new IndexPage(driver);

        Assert.assertEquals(driver.getTitle(), "Admin Page!");
        Assert.assertEquals(driver.getCurrentUrl(), "http://127.0.0.1:5500/admin.html");
